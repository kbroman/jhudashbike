...
points.in.baltimore <- function(longitude.vector, latitude.vector){
...
return(
  point.in.polygon(longitude.vector, latitude.vector, 
                        pol.x = bdy[,1], pol.y = bdy[,2], mode.checked=FALSE) > 0 )
